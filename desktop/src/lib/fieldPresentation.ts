...
const LABELS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    alert_at: "Usage alert levels", alert_reset: "Notify on limit reset", source: "Usage source",
  ...
  cs: {
    ...
    alert_at: "Úrovně upozornění na využití", alert_reset: "Upozornit na obnovu limitu", source: "Zdroj využití",
