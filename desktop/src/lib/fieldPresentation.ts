...
const LABELS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    management: "Launcher layout", agent_order: "Agent order", agent_slots: "Agent slots", show_profile_on_panel: "Show active profile",
  ...
  cs: {
    ...
    management: "Rozložení spouštěčů", agent_order: "Pořadí agentů", agent_slots: "Místa pro agenty", show_profile_on_panel: "Zobrazit aktivní profil",
