...
export const FIELD_HELP: Record<Lang, Record<string, SectionHelp>> = {
  en: {
    ...
    view: {
      ...
      project_icons: "Repo name → icon file on the deck machine (PNG/ICO ≤256 KiB; SVG only where CairoSVG is installed); overrides the repo favicon.",
  ...
  cs: {
    ...
    view: {
      ...
      project_icons: "Název repa → ikona na stroji s deckem (PNG/ICO ≤256 KiB; SVG jen tam, kde je nainstalované CairoSVG); přebije favicon z repa.",
