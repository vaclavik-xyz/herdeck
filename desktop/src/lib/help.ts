...
export const FIELD_HELP: Record<Lang, Record<string, SectionHelp>> = {
  en: {
    ...
    theme: {
      ...
      waiting: "Tile color of a pane held pending background work — CI, review, a marker (herdwatch; default violet).",
  ...
  cs: {
    ...
    theme: {
      ...
      waiting: "Barva dlaždice drženého kvůli práci na pozadí — CI, review, marker (herdwatch; výchozí violet).",
