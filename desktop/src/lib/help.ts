...
export const FIELD_HELP: Record<Lang, Record<string, SectionHelp>> = {
  en: {
    ...
    view: {
      ...
      tile_primary: "First tile line from built-in fields or $name metadata tokens; unset = repo, empty = off.",
  ...
  cs: {
    ...
    view: {
      ...
      tile_primary: "První řádek z vestavěných polí nebo metadata tokenů $name; nevyplněno = repo, prázdné = vypnuto.",
