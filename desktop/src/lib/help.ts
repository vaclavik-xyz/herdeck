...
export const FIELD_HELP: Record<Lang, Record<string, SectionHelp>> = {
  en: {
    ...
    view: {
      ...
      tile_secondary: "Second line from built-in fields or $name metadata tokens; unset = tab then branch, empty = off.",
  ...
  cs: {
    ...
    view: {
      ...
      tile_secondary: "Druhý řádek z polí nebo tokenů $name; nevyplněno = tab a branch, prázdné = vypnuto.",
